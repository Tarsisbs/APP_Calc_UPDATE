    ...
    <ScrollView showsVerticalScrollIndicator = {false} style = {styles.viewScroll}>
      ...
      <View style = {styles.viewPrincipal}>
        ...
        <View style = {styles.viewImage}>
          ...
          <View style = {styles.viewBtnOpera}>

            <TouchableOpacity style = {styles.botao} onPress={somar}>+</TouchableOpacity>

            <TouchableOpacity style = {styles.botao} onPress={subtrair}>-</TouchableOpacity>

            <TouchableOpacity style = {styles.botao} onPress={multiplicar}>*</TouchableOpacity>

            <TouchableOpacity style = {styles.botao} onPress={dividir}>/</TouchableOpacity>
